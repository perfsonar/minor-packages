...
function Speed(options){
    ...
    if ( this.options.classicColor ) {
        ...
        estyle.addColorStop(0.0,"rgba(0,0,255," + this.options.emptyAlpha + ")");
        estyle.addColorStop(0.1,"rgba(0,0,255," + this.options.emptyAlpha + ")");
    ...
    if ( this.options.classicColor ) {
        ...
        fstyle.addColorStop(0.0,"rgba(0,0,255,1)");
        fstyle.addColorStop(0.1,"rgba(0,0,255,1)");
