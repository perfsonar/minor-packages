...
function Speed(options){
    ...
    this.options = {
        ...
        // defaults
        "classicColor": 1,          // red/green by default
        "maxValue": 10000,          // 10G
        "numBars": 50,              // how many bars
        ...
        "dataStalePeriod":  20,     // seconds - when to show 'inactive'
    ...
    if ( this.options.classicColor ) {
        estyle.addColorStop(1.0,"rgba(0,255,0," + this.options.emptyAlpha + ")");
        estyle.addColorStop(0.9,"rgba(0,255,0," + this.options.emptyAlpha + ")");
        ...
        estyle.addColorStop(0.1,"rgba(255,0,0," + this.options.emptyAlpha + ")");
        estyle.addColorStop(0.0,"rgba(255,0,0," + this.options.emptyAlpha + ")");
    }
    else {
        estyle.addColorStop(1.0,"rgba(0,0,255," + this.options.emptyAlpha + ")");
        estyle.addColorStop(0.9,"rgba(0,0,255," + this.options.emptyAlpha + ")");

        estyle.addColorStop(0.55,"rgba(255,0,255," + this.options.emptyAlpha + ")");
        estyle.addColorStop(0.45,"rgba(255,0,255," + this.options.emptyAlpha + ")");
    ...
    if ( this.options.classicColor ) {
        fstyle.addColorStop(1.0,"rgba(0,255,0,1)");
        fstyle.addColorStop(0.9,"rgba(0,255,0,1)");

        fstyle.addColorStop(0.55,"rgba(255,255,0,1)");
        fstyle.addColorStop(0.45,"rgba(255,255,0,1)");

        fstyle.addColorStop(0.1,"rgba(255,0,0,1)");
        fstyle.addColorStop(0.0,"rgba(255,0,0,1)");
    }
    else {
        fstyle.addColorStop(1.0,"rgba(0,0,255,1)");
        fstyle.addColorStop(0.9,"rgba(0,0,255,1)");
 
        fstyle.addColorStop(0.55,"rgba(255,0,255,1)");
        fstyle.addColorStop(0.45,"rgba(255,0,255,1)");
...
Speed.prototype.refresh = function(){
    ...
    this.ctx.beginPath();
    for(var i=(this.options.numBars - nBars); i < (this.options.numBars); i++){
    ...
    if(nBars < this.options.numBars){
        ...
        this.ctx.beginPath();
        for(var i=0; i < (this.options.numBars - nBars); i++){
            this.ctx.rect(0,(hb*i)+(.5*hl),w,hl);
        }
        this.ctx.closePath();
        this.ctx.fill();
