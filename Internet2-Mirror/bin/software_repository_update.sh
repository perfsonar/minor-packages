#!/bin/sh
# Internet2 Software Repository Mirror Script
# 
...
REPOSITORY=https://cvs3.internet2.edu/svn/software/

ARCHITECTURES=(i386 x86_64 ppc)
#ARCHITECTURES=(i386)

DEST_REPO_DIR=/opt/perfsonar_ps/Internet2-Mirror/software.internet2.edu
